...
/**
 * @extends ServiceEntityRepository<LoginForm>
 *
 ...
 */
class LoginFormRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(LoginForm $entity, bool $flush = false): void
    {
    ...
    public function remove(LoginForm $entity, bool $flush = false): void
    {
